        ...
        <div class="modal fade" id="tracking-modal" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="content-group-1 text-center d-none"></div>
                    <div class="content-group-2">
                        <div class="modal-body d-flex flex-column" style="gap: .5rem;">
                            <div>
                                ...
                                <span id="pu-loc">Long Thành, Đồng Nai</span>
                            </div>
                            <div>
                                <i class="bi bi-geo-alt-fill"></i>
                                <span class="ms-2 fw-semibold">Deliver to:</span>
                                <span id="do-loc" class="text-danger">sign in to view this information</span>
                            </div>
                            <div>
                                <i class="bi bi-cash"></i>
                                <span class="ms-2 fw-semibold">Fee:</span>
                                <span id="d-fee">57.000 (VND)</span>
                            </div>
                            <div>
                                <i class="bi bi-truck-front-fill"></i>
                                <span class="ms-2 fw-semibold">Status:</span>
                                <span id="d-status" class="text-primary">Package is being delivered</span>
                            </div>
                        </div>
