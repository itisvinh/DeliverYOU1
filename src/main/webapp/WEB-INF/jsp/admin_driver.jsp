                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#driver-management-modal">More
                            </button>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="modal-body d-flex justify-content-center flex-column">
                ...
                <div class="d-flex justify-content-center">
                    <div class="editable-img">
                        ...
                        <img id="driver-avatar" class="img-thumbnail shadow rounded-circle" style="width: 5rem; height: 5rem"
                ...
                <div class="input-group w-100">
                    ...
                    <input id="driver-fname" type="text" value="7474"/>
                </div>

                <div class="input-group w-100 mt-2">
                    <div class="title">Last name</div>
                    <input id="driver-lname" type="text" value="7474"/>
                </div>

                <div class="input-group w-100 mt-2">
                    <div class="title">Citizen ID</div>
                    <input id="driver-citizen-id" type="text" value="7474"/>
                </div>

                <div class="input-group w-100 mt-2">
                    <div class="title">Email</div>
                    <input id="driver-email" type="text" value="7474"/>
                </div>

                <div class="input-group w-100 mt-2">
                    <div class="title">Phone number</div>
                    <input id="driver-phone" type="text" value="7474"/>
                </div>

            </div>
            <div class="d-none" id="modal-driver-id" data-id="0"></div>

            <div class="modal-footer p-1">
                <button type="button" class="btn btn-danger" onclick="deleteUser()" data-bs-dismiss="modal">Remove</button>
...
<div class="toast-container position-fixed end-0 p-3" style="bottom: 5rem; position: absolute; z-index: 20000">
    <div id="live-toast" class="toast align-items-center text-bg-primary border-0" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="d-flex">
